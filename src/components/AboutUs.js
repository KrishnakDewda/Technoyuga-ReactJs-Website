    ...
    return (
        <div>
            ...
            <main id="main">
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="hero-wrapper">
                                    <h2>The right <span>technology partner</span> can change everything</h2>
                ...
                <section className="what-we-believe" data-aos="fade-up" data-aos-delay="300">
                    <div className="container">
                        <h4 className="text-center">What We Believe in</h4>
                        <h2 className="text-center">Honesty , Integrity and Transparency</h2>
                        <p className="text-center">At Technoyuga, our product managers and engineers are trained in a culture that promotes 100% transparency. We are not a team of “yes-men'' who will let you follow the wrong path.</p>
                        <div className="row">
                            <div className="col-md-6">
                                <p className="content">We believe in long-term results and stay away from ‘quick wins’ that don’t last. We approach every project as true technology partners along with delivering the required technology solution, we work hard with our clients to understand their business domain, and revenue model. We emphasize on areas that could be enhanced and optimized to get more customers and eventually help in generating revenue for clients.. We understand our success is directly proportional with our client’s success.</p>
                            </div>
                            <div className="col-md-6">
                                <img src="img/what-we-believe.png" className="img-fluid" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="journey-begins">
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6">
                ...
                <section className="ios-process">
                    <div className="container">
                        <div className="section-title" data-aos="fade-up">
                            ...
                            <p className="title-para">Your project in the safe hands and is our responsibility. We are the team of technology experts that care for your success. We believe in long-term results and stay away from ‘quick wins’ that don’t last. We approach every project as true technology partners along with delivering the required technology solution.</p>
                        </div>
                ...
                <section className="call-to-action">
                    <div className="container">
                        <div className="call-content">
                            <h2>Do you have a Idea?</h2>

                            <p>Book a discovery call to validate your idea and get a free roadmap document of your product development, marketing and revenue model.</p>
                ...
                <div className="footer-top">
                    <div className="container">
                        <div className="footer-nav">
                            <img src="img/technoyuga-logo-w.svg" alt="tech logo" />
                            <ul>
                                <li className="active"><a href="/">Home</a></li>
