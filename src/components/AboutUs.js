    ...
    return (
        <div>
            ...
            <main id="main">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="hero-wrapper">
                                    ...
                                    <div class="actn-btns">
                                        <a href="/contactus" class="primary">Let’s work together</a>
                                        <a href="/ourstory" class="primary invert">Read our story</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <section class="what-we-believe" data-aos="fade-up" data-aos-delay="300">
                    <div class="container">
                        <h4 class="text-center">What We Believe in</h4>
                        <h2 class="text-center">Honesty , Integrity and Transparency</h2>
                        <p class="text-center">At Technoyuga, our product managers and engineers are trained in a culture that promotes 100% transparency. We are not a team of “yes-men'' who will let you follow the wrong path.</p>
                        <div class="row">
                            <div class="col-md-6">
                                <p class="content">We believe in long-term results and stay away from ‘quick wins’ that don’t last. We approach every project as true technology partners along with delivering the required technology solution, we work hard with our clients to understand their business domain, and revenue model. We emphasize on areas that could be enhanced and optimized to get more customers and eventually help in generating revenue for clients.. We understand our success is directly proportional with our client’s success.</p>
                            </div>
                            <div class="col-md-6">
                                <img src="img/what-we-believe.png" class="img-fluid" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="journey-begins">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="img/office.png" class="img-fluid" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="ios-process">
                    <div class="container">
                        ...
                        <div class="row border-b">
                            ...
                            <div class="col-md-4 hover-dark border-right-left" data-aos="fade-in" data-aos-delay="200">
                                <div class="ios-process-inner">
                            ...
                            <div class="col-md-4 hover-dark" data-aos="fade-in" data-aos-delay="300">
                                <div class="ios-process-inner">
                        ...
                        <div class="row">
                            <div class="col-md-4 hover-dark" data-aos="fade-in" data-aos-delay="400">
                                <div class="ios-process-inner">
                                    <svg width="82" height="60" viewBox="0 0 82 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="52" cy="30" r="30" fill="#E0F9FF" />
                            ...
                            <div class="col-md-4 hover-dark border-right-left" data-aos="fade-in" data-aos-delay="500">
                                <div class="ios-process-inner">
                            ...
                            <div class="col-md-4 hover-dark" data-aos="fade-in" data-aos-delay="600">
                                <div class="ios-process-inner">
                ...
                <section class="call-to-action">
                    <div class="container">
                        <div class="call-content">
                            ...
                            <a href="/contactus">schedule a call</a>
                        </div>
                    </div>
                </section>
                ...
                <div class="container">
                    <div class="copy">
                        ...
                        <div class="social-media">
                            <ul>
                                <li><a target="_blank" href="https://www.linkedin.com/company/technoyuga-pvt-ltd"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                <li><a target="_blank" href="https://www.instagram.com/techno_yuga"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                <li><a target="_blank" href="https://twitter.com/TechnoYuga"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
