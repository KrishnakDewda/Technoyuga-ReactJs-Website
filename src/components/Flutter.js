    ...
    return (
        <div>
            ...
            <main>
                            ...
                            <div className="row">
                                <div className="col col-12 col-lg-6">
                                    <div className="hire-details">
                                        <h2 className="hire-details-title">Hire Flutter</h2>
                                        ...
                                        <p className="hire-details-point-item">You are at the right place if you are looking for
                                            hiring
                                            flutter developers. At Technoyuga we have a team of over 15+ flutter developers who
                                            are
                                            working on flutter since it was in beta phase back in 2017-18 also we have been
                                            working
                                            on all flutter versions. Having worked over multiple Flutter App Development
                                            projects,
                                            building several apps for iOS, android, Desktop and web platform. Flutter developers
                                            at
                                            Technoyuga are a right mix of skill and experience and the result speaks in the
                                            words of
                                            our clients in their testimonials.
                                        </p>
                                        <ul className="hire-details-check-point mt-0">
                                            <li className="hire-details-check-pitem"><img src="img/hire_check.png" alt=""
                                                className="img-fluid" /> Maintenance Of your Existing Flutter App</li>
                                            <li className="hire-details-check-pitem"><img src="img/hire_check.png" alt=""
                                                className="img-fluid" /> Flutter App Development From Scratch</li>
                                            <li className="hire-details-check-pitem"><img src="img/hire_check.png" alt=""
                                                className="img-fluid" />MVP Development</li>
                                            <li className="hire-details-check-pitem"><img src="img/hire_check.png" alt=""
                                                className="img-fluid" /> Flutter Web App Development</li>
                                            <li className="hire-details-check-pitem"><img src="img/hire_check.png" alt=""
                                                className="img-fluid" /> Front End Development</li>
                                        </ul>
                                        <div className="hire-details-btn">
                                            <button className="btn btn-info hire-trial-btn" onClick={() => plan.current.scrollIntoView({ behavior: 'smooth', block: 'start' })}>Start Risk Free Trial</button>
                                            <button className="btn btn-info" onClick={() => plan.current.scrollIntoView({ behavior: 'smooth', block: 'start' })}>Check our Pricing</button>
                                        </div>
                                    </div>
                                </div>
                                <Consultant />
                            ...
                            <div className="startup-slider">
                                ...
                                >
                                    <div className="startup-img">
                                        <img src="img/startup_2.png" alt="" className="img-fluid" style={{ margin: '0 auto !important' }} />
                                    </div>
                                    <div className="startup-img">
                                        <img src="img/startup_3.png" alt="" className="img-fluid" style={{ margin: '0 auto !important' }} />
                                    </div>
                                    <div className="startup-img">
                                        <img src="img/startup_4.png" alt="" className="img-fluid" style={{ margin: '0 auto !important' }} />
                                    </div>
                                    <div className="startup-img">
                                        <img src="img/startup_5.png" alt="" className="img-fluid" style={{ margin: '0 auto !important' }} />
                                    </div>
                                    <div className="startup-img">
                                        <img src="img/startup_6.svg" alt="" className="img-fluid" style={{ margin: '0 auto !important' }} />
                                    </div>
                                    <div className="startup-img">
                                        <img src="img/startup_7.png" alt="" className="img-fluid" style={{ margin: '0 auto !important' }} />
                                    </div>
                                    <div className="startup-img">
                                        <img src="img/startup_8.png" alt="" className="img-fluid" style={{ margin: '0 auto !important' }} />
                                    </div>
                                    <div className="startup-img">
                                        <img src="img/startup_1.png" alt="" className="img-fluid" style={{ margin: '0 auto !important' }} />
                                    </div>
                                </OwlCarousel>
                            </div>
                    ...
                    <div className="container">
                        <div className="stories-content">
                            <div className="section-title aos-init aos-animate" data-aos="fade-up">
                                ...
                                <p>Following are some of our Flutter Projects that have been a great
                                    ...
                                    {/* <div className="stories-slider-item">
                                        <div className="stories-slider-link storie-clubbrub-link">
                                            ...
                                            <div className="stories-slider-details medizen-app-details">
                                                ...
                                                <h4 className="stories-details-subtitle">About Project</h4>
                                                <p className="stories-details-discription">Clubgrub Golfer app allows golfers to get On-demand food & beverage ordering with on-course delivery.
                                                    This app is changing the dynamics of the food and beverages ordering for the Golf Industry in the United States.
                                                </p>
                                                <div className="stories-team stories-techology-stack bg-transparent p-0">
                                                    <p className="stories-stack-title">Technology Stack</p>
                                                    <div className="stories-team-member">
                ...
                <section className="development-section p-0">
                    <div className="container">
                        <div className="development-content">
                            <div className="section-title aos-init aos-animate" data-aos="fade-up">
                                <h2>Flutter Development Stack</h2>
                                <p>At TechoYuga we use the scalable and trending frameworks and
                                            ...
                                            <div className="row justify-content-end">
                                                ...
                                                <div className="col col-6 col-md-6 col-lg-6 col-xl-2">
                                                    <div className="development-tools-img">
                                                        ...
                                                        <h5 className="development-tools-name">SQL Lite</h5>
                                                    </div>
                                                </div>
                                                <div className="col col-6 col-md-6 col-lg-6 col-xl-2">
                                                    <div className="development-tools-img">
                ...
                <section className="hiring-section section-padding">
                    <div className="container">
                        <div className="hiring-content">
                            <div className="section-title aos-init aos-animate" data-aos="fade-up">
                                <h2>Hiring As Easy As Three Steps</h2>
                            </div>
                ...
                <section className="schedule-section p-0">
                    <div className="container">
                        <div className="schedule-content">
                            <div className="section-title aos-init aos-animate" data-aos="fade-up">
                                <h2>Why You Should Hire Flutter Developer from Technoyuga</h2>
                            </div>
                            <div className="row">
                                <div className="col col-12 col-md-12 col-lg-12 col-xl-5">
                                    <div className="schedule-details">
                                        ...
                                        <a href="#" className="btn schedule-btn">Schedule Interview with Developers</a>
                                    </div>
                                </div>
                ...
                <section className="requirement-section section-padding" ref={plan}>
                    <div className="container">
                        <div className="requirement-content">
                            <div className="section-title aos-init aos-animate" data-aos="fade-up">
                                <h2>Hire flutter developers as per your requirements</h2>
                            </div>
                                    ...
                                    >
                                        <div className="industry-item">
                                            ...
                                            <div className="industry-item-details">
                                                <p className="industry-discription">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore</p>
                            ...
                            <div className="testimonial-item">
                                <div className="company-info">
                                    ...
                                    <p>10X partners is a parent company of Foodio, a food tech community for consumers,
                                        ...
                                        hustle.</p>
                                    <img className="country-flag" src="img/flags/" alt="NA" />
                                </div>
                                <div className="testimonial-content">
                                    <div className="client-tent-video">
