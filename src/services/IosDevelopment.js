                    ...
                    <div className="row">
                        <div className="col-lg-7 mb-5 mb-lg-0">
                            <div className="ios-banner">
                                <img className="img-fluid" src="img/iphone-app.png" alt="ios mobile app" />
                            </div>
                        </div>
            ...
            <main id="main">
                ...
                <section className="call-request-section" data-aos="fade-up" data-aos-delay="100">
                    <div className="container">
                        <h4>Technoyuga is a top rated iPhone app development company <br /><span>that is helping startups, small businesses and growing enterprises around the world develop in building iOS apps.</span></h4>
                    </div>
                </section>
                ...
                <section className="platforms">
                    <div className="container">
                        <div className="section-title" data-aos="fade-up">
                            <h2>Platforms</h2>
                            <p>Reach your customers across the entire spectrum of Apple devices</p>
                            <p className="font-weight-bold">digital services</p>
                        </div>
                        <div data-aos="fade-up" data-aos-delay="100">
                            <img src="img/ios-devices.png" className="img-fluid" />
                        </div>
                    </div>
                </section>
                ...
                <section className="ios-process">
                    <div className="container">
                        <div className="section-title" data-aos="fade-up">
                            <h2>Your iPhone app project in the safe hands:</h2>
