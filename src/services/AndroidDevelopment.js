            ...
            <header id="header" class="fixed-top dark-header">
                <div class="container-fluid d-flex">
                    ...
                    <div class="logo mr-auto">
                        <a href="/"><img src="img/technoyuga-logo.svg" alt="technoyuga logo" class="img-fluid" /></a>
                    </div>
                    ...
                    <nav class="nav-menu d-none d-lg-block">
                        <ul>
                            ...
                            <li class="drop-down mega"><a href="#0">Services</a>
                                <ul class="row">
                                    <li class="col-lg-4">
                                        <div class="media">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-7 mb-5 mb-lg-0">
                            <div className="ios-banner">
                                <img className="img-fluid" src="img/andriod-bg.png" alt="android app development" />
                            </div>
                        </div>
            ...
            <main id="main">
                ...
                <section className="call-request-section" data-aos="fade-up" data-aos-delay="100">
                    <div className="container">
                        <h4>Technoyuga is a top rated android app development company <br /><span>that is helping startups, small businesses and growing enterprises around the world develop in building android apps.</span></h4>
                        {/* <a href="#" className="request-btn">REQUEST A CALL BACK</a> */}
                    </div>
                </section>
                ...
                <section className="what-we-do">
                    <div className="container">
                        <div className="section-title" data-aos="fade-up">
                            <h2>What We Do</h2>
                            <p>Get Precisely what you need for your business and how you want</p>
                        </div>
                    </div>

                    {window.innerWidth < 420 ?

                        <div className="ios-services">
                            <OwlCarousel
                                loop
                                margin={10}
                                autoplay
                            ...
                            >
                                <div className="ios-service-list light" data-aos="fade-in">
                                    <img className="img-fluid" src="img/development.svg" alt="development" />
                                    <h5>Custom Native iPhone App Development</h5>
                                </div>

                                <div className="ios-service-list dark" data-aos="fade-in" data-aos-delay="100">
                                    <img className="img-fluid" src="img/maintenance.svg" alt="app maintenance" />
                                    <h5>iPhone App Support and Maintenance</h5>
                                </div>

                                <div className="ios-service-list light" data-aos="fade-in" data-aos-delay="200">
                                    <img className="img-fluid" src="img/flutter.svg" alt="flutter" />
                                    <h5>iPhone App Development Using Flutter</h5>
                                </div>

                                <div className="ios-service-list dark" data-aos="fade-in" data-aos-delay="300">
                                    <img className="img-fluid" src="img/native.svg" alt="native" />
                                    <h5>iPhone App Development Using React Native</h5>
                                </div>
                            </OwlCarousel>
                        </div>
                        :
                ...
                <section className="platforms">
                    <div className="container">
                        <div className="section-title" data-aos="fade-up">
                            <h2>Platforms</h2>
                            <p>Reach your customers across the entire spectrum of Android devices</p>
                            <p className="font-weight-bold">digital services</p>
                        </div>
                        <div className="text-center" data-aos="fade-up" data-aos-delay="100">
                            <img src="img/android-devices.png" className="img-fluid android-devices" />
                        </div>
                    </div>
                </section>
                ...
                <section className="ios-process">
                    <div className="container">
                        <div className="section-title" data-aos="fade-up">
                            <h2>Your android app project in the safe hands:</h2>
                ...
                <section className="what-we-do">
                    <div className="container">
                        <div className="section-title" data-aos="fade-up">
                            ...
                            <p className="title-para">At Techno Yuga we truly believe in the power of domain expertise. By choosing a partner with experience in an industry, the product is better, while timelines and cost are kept low. We are experts in:</p>
                        </div>
                    ...
                    <div className="bubble2"><img src="img/bubbles2.svg" alt="two big circle" /></div>
                </section>
