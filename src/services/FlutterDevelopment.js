...
const FlutterDevelopment = () => {
    return (
        <div>
            ...
            <section className="ar-vr-hero block-chain-hero flutter-hero">

                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-5 mb-5 mb-lg-0">
                            <div className="flutter-banner">
                                <img className="img-fluid" src="img/flutter logo.svg" alt="flutter app development" />
                            </div>
                        </div>
            ...
            <main id="main">
                ...
                <section className="call-request-section" data-aos="fade-up" data-aos-delay="100">
                ...
                <section className="what-is-flutter">
                    <div className="container">
                        <h2 data-aos="fade-up" data-aos-delay="100">WHAT IS FLUTTER ?</h2>
                        <div className="flutter-device" data-aos="fade-in" data-aos-delay="300">
                            <img className="img-fluid" src="img/what-flutter.png" alt="flutter mobile app developer" />
                            <div className="flutter-play-btn">
                                <img data-toggle="modal" data-target="#ep1" src="img/play.svg" alt="play button" />
                            </div>
                        </div>
                        <div className="google-img" data-aos="fade-in" data-aos-delay="500">
                            <img src="img/made-by-google.png" alt="google logo" />
                        </div>
                ...
                <section>
                    <div className="container">
                        <div className="flutter-client">
                            <h5 className="text-center" data-aos="fade-up" data-aos-delay="100">Some of the brands using flutter for their mobile apps:</h5>
                            {window.innerWidth < 420 ?
                                <ul>
                                    ...
                                    >
                                        <li data-aos="fade-in" data-aos-delay="200"><img className="img-fluid" src="img/alibaba.png" alt="alibaba logo" /></li>
                                        <li data-aos="fade-in" data-aos-delay="300"><img className="img-fluid" src="img/ebay.png" alt="ebay logo" /></li>
                                        <li data-aos="fade-in" data-aos-delay="400"><img className="img-fluid" src="img/bmw.png" alt="bmw logo" /></li>
                                        <li data-aos="fade-in" data-aos-delay="500"><img className="img-fluid" src="img/birch.png" alt="birch logo" /></li>
                                        <li data-aos="fade-in" data-aos-delay="600"><img className="img-fluid" src="img/dream11.png" alt="dream11 logo" /></li>
                                    </OwlCarousel>
                                </ul>
                                :
                                <ul>
                ...
                <section className="why-use">
                    <div className="container">
                        <h3 className="text-center">Why should you Use Flutter for your Mobile App Development Project?</h3>
                        <div className="use-of-wrapper">
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="inner-wrapper">
                                        <img src="img/use-of/native-perfo.svg" />
                                        <h5>Native Performance</h5>
                                        <p>Flutter apps run via natively compiled code. There are no interpreters involved. This means Flutter apps start fast and provide amazing native experience to app users.</p>
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="inner-wrapper">
                                        <img src="img/use-of/launch-time.svg" />
                                        <h5>Faster Launch time</h5>
                                        <p>Flutter provides a rich set of customizable widgets to develop native components. Flutter’s Hot Reload facilitates developer-designer cooperation. Any improvements or modifications with the look and feel of an app can be done on the fly which reduce the development time. This means you can launch your apps faster.</p>
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="inner-wrapper">
                                        <img src="img/use-of/cost-benifits.svg" />
                                        <h5>Cost Benifits</h5>
                                        <p>Being the startup cost plays a major role. Flutter uses a single codebase (In most of the scenarios) which reduces our efforts by at least 30% and we transfer this benefit to our client by reducing the development cost.</p>
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="inner-wrapper">
                                        <img src="img/use-of/web-support.svg" />
                                        <h5>Web Version Support</h5>
                                        <p>Flutter for web allows the developers to compile flutter application source code to web browsers like Chrome, Firefox etc. We can deploy your mobile app code for the web version without modifying it.</p>
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="inner-wrapper">
                                        <img src="img/use-of/desktop-support.svg" />
                                        <h5>Desktop App Support</h5>
                                        <p>Flutter for desktop provides a mechanism to our developers so they can compile flutter mobile app code to native Windows and macOS</p>
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="inner-wrapper">
                                        <img src="img/use-of/beautiful-ui.svg" />
                                        <h5>Beautiful UI</h5>
                                        <p>Flutter apps look nice and feel great. Flutter framework provides interactive and customizable widgets. We can also do the tailor made UI design and at same time integrate the pre-made beautiful and customisable widgets.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="what-flutter-text text-center" data-aos="fade-up" data-aos-delay="600">
                                <a className="call-request mt-4" href="/contact-us">Speak to flutter Developer</a>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="development-stack">
                    <div className="container">
                        <div className="section-title" data-aos="fade-up">
                            <h2>Mobile Development Stack</h2>
                            <p>At TechoYuga we use the scalable and trending frameworks and technologies to build Mobile Apps , Backend and Web applications for our clients.</p>
                        </div>
                    </div>
                    <div className="container">
                        <div className="row">
                                    ...
                                    <div className="tech-content">
                                        <div className="skills-list">
                                            ...
                                            <ul>
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/swift.svg" alt="swift" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Swift</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/kotlin.svg" alt="kotlin" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Kotlin</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/java.svg" alt="java" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Java</p>
                                                    </figcaption>
                                    ...
                                    <div className="tech-content">
                                        <div className="skills-list">
                                            ...
                                            <ul>
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/firebase.svg" alt="firebase" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Firebase</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/realm.svg" alt="realm" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Realm</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/sw-lite.svg" alt="sw lite" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>SQLite</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/mongo-db.svg" alt="mongo db" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>MongoDB</p>
                                                    </figcaption>
                                    ...
                                    <div className="tech-content">
                                        <div className="skills-list">
                                            ...
                                            <ul>
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/flutter.svg" alt="flutter" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Flutter</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/react-native.svg" alt="react native" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Reach Native</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/rx-java.svg" alt="rx java" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Rx Java</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/junit.svg" alt="junit" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>JUnit</p>
                                                    </figcaption>
                                    ...
                                    <div className="tech-content">
                                        <div className="skills-list">
                                            ...
                                            <ul>
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/aws-tech.png" alt="aws" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>AWS</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/heroku.png" alt="heroku" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Heroku</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/google-cloud.png" alt="google cloud" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Google Cloud</p>
                                                    </figcaption>
                                                ...
                                                <li>
                                                    <figure>
                                                        <img className="img-fluid" src="img/icon/digi-ocean.png" alt="digital ocean" />
                                                    </figure>
                                                    <figcaption>
                                                        <p>Digital Ocean</p>
                                                    </figcaption>
                            ...
                            >
                                ...
                                <div className="folio-item">
                                    <div className="gradient-bg gradient6">
                                        <img data-aos="fade-down" className="slider-img img-fluid" src="img/portfolio/ordeno/project-image.png"
                                            alt="order management system development" />
                                    </div>
                ...
                <section className="process">
                    <div className="container">
                            ...
                            <div id="process-content" className="tab-content tab-wrapper" role="tablist">
                                ...
                                >
                                    <div id="process-idea" className="process-content tab-pane fade show active" role="tabpanel">
                                        <div id="collapse-A" className="no-collapse show" data-parent="#process-content" role="tabpanel" aria-labelledby="heading-A">
                                            <div className="card-body">
                                                <img className="mobile-visible" src="img/process/idea.svg" alt="idea" />
                                                <h2>Project Discovery</h2>
                                                <p>We provide no obligation free consultation to our clients related to their project and The purpose of this call is to understand challenges they are trying to solve, industry, competitors, USP’s, brainstorm and map your idea to develop it into a one kind of Product.</p>
                                    ...
                                    <div id="process-wireframe" className="process-content tab-pane fade show active" role="tabpanel">
                                        <div id="collapse-b" className="no-collapse" data-parent="#process-content" role="tabpanel" aria-labelledby="heading-b">
                                            <div className="card-body">
                                                <img className="mobile-visible" src="img/process/wireframe.svg" alt="wireframe" />
                                                <h2>Technical Documentation</h2>
                                                <p>Once we have a thorough understanding of the project idea , we begin capturing all of the requirements in a technical specification document (Project Scope) and revise it a few times as per your feedback. Based on your approval we will share the detailed proposal and agreement.</p>
                                                <div className="big-circle"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="process-design" className="process-content tab-pane fade show active" role="tabpanel">
                                        <div id="collapse-c" className="no-collapse" data-parent="#process-content" role="tabpanel" aria-labelledby="heading-c">
                                            <div className="card-body">
                                                <img className="mobile-visible" src="img/process/design.svg" alt="design process" />
                                                <h2>UI and UX Design</h2>
                                                <p>When it comes to first impressions, it’s all UI and User experience (UX) they get while using your app. As part of this process, our clients work with our digital product design team to bring your project concept to live. We also provide clickable prototypes so you can experience the app flow without even getting this developed.</p>
                                                <div className="big-circle"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="process-development" className="process-content tab-pane fade show active" role="tabpanel">
                                        <div id="collapse-d" className="no-collapse" data-parent="#process-content" role="tabpanel" aria-labelledby="heading-d">
                                            <div className="card-body">
                                                <img className="mobile-visible" src="img/process/development.svg" alt="development process" />
                                                <h2>Development</h2>
                                                <p>Since now we have captured the Functionality and UI/CX. Our Development team begins coding the entire Mobile apps and Backend/API. The development process is broken down into multiple sprints. Our agile-based development process will allow you to regularly review and assess what we’re building and you also get regular builds/Apk and URL to test the features on a weekly basis.</p>
                                                <div className="big-circle"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="process-test" className="process-content tab-pane fade show active" role="tabpanel">
                                        <div id="collapse-e" className="no-collapse" data-parent="#process-content" role="tabpanel" aria-labelledby="heading-e">
                                            <div className="card-body">
                                    ...
                                    <div id="process-launch" className="process-content tab-pane fade show active" role="tabpanel">
                                        <div id="collapse-f" className="no-collapse" data-parent="#process-content" role="tabpanel" aria-labelledby="heading-f">
                                            <div className="card-body">
                                                <img className="mobile-visible" src="img/process/launch.svg" alt="launch" />
                                                <h2>Deployment and Maintenance</h2>
                                                <p>After passing through a final round of QA and client approval. We manage the submission of the app to the Google and Apple stores and get your app guaranteed approved. We will also help in any bug or issues come after live and will provide the free 90 Days extended support after going live.</p>
                                                <div className="big-circle"></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <ul className="ps-timeline nav nav-tabs" role="tablist">
                            ...
                            <li>
                                <a data-toggle="tab" href="#process-wireframe"><img src="img/process/wireframe.svg" alt="wireframe" /></a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#process-design"><img src="img/process/design.svg" alt="design process" /></a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#process-development"><img src="img/process/development.svg" alt="development process" /></a>
                            </li>
                            <li>
                    ...
                    <div className="bubble1"><img src="img/circle1.svg" alt="circle" /></div>
                </section>
                            ...
                            <div className="card mb-0">
                                <div className="faq-wrapper">
                                    ...
                                    <div id="collapseOne" className="card-body collapse" data-parent="#accordion" >
                                        <p>Yes We can help you with the Flutter Web application. Flutter allows developers to compile flutter application source code to web browsers like Chrome, Firefox etc. We can deploy your mobile app code for the web version without modifying it</p>
                                    </div>
                                </div>
                                <div className="faq-wrapper">
                                    ...
                                    <div id="collapseTwo" className="card-body collapse" data-parent="#accordion" >
                                        <p>Flutter allows our developers to use a single code-base and provide themmechnaism to build both Android as well as iOS mobile apps. Hence you get mobile apps for two platforms on the cost of one app development.</p>
                                        <p>This means as a company we are saving one resource's efforts, compared to native app development process. This helps us to reduce our cost and provide the cost benefits to our clients.</p>
                                    </div>
                                </div>
                                <div className="faq-wrapper">
                                    ...
                                    <div id="collapseThree" className="collapse" data-parent="#accordion" >
                                        <div className="card-body">
                                            <p>Indeed it's good. Since Flutter provides a rich set of customizable widgets to develop native components. Flutter’s Hot Reload facilitates developer-designer cooperation. Any improvements or modifications with the look and feel of an app can be done on the fly which reduce the development time. This means you can launch your MVP fast and get your audience feedback/acceptance faster and enhance your apps accordingly.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="faq-wrapper">
                                    ...
                                    <div id="collapseFour" className="card-body collapse" data-parent="#accordion" >
                                        <p>Yes plenty of startups and established brands are using flutter for their app development needs. You can check few of them listed as mentioned below:</p>
                                        <ul>
                                            <li>Google Ads App</li>
                                            <li>Alibaba</li>
                                            <li>Dream 11</li>
                                            <li>Topline App and many more.</li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="faq-wrapper">
                                    ...
                                    <div id="collapseFive" className="card-body collapse" data-parent="#accordion" >
                                        <p>We have been working on flutter when it was in beta and since then we have built various apps using flutter and helped startups and established businesses worldwide. Additionally we are one of the highly recognized in flutter development category with total 15+ Jobs successfully delivered with 4.9* Average rating. </p>
                                    </div>
                                </div>
                                <div className="faq-wrapper">
                                    <div className="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSix">
                                        <a className="card-title">
                                            How do you insure the privacy of my Flutter App Development Project?
                                        </a>
                                    </div>
                                    <div id="collapseSix" className="collapse" data-parent="#accordion" >
                                        <div className="card-body">
                                            <p>Being a responsible flutter app development company we respect the confidentiality of our client and considering that in mind we sign the legal Non disclosure agreement with our clients and follow that strictly.
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="modal fade" id="ep1">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/5VbAwhBBHsg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
