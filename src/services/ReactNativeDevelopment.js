    ...
    return (
        <div>
            ...
            <section className="ar-vr-hero">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-8 mb-5 mb-lg-0" data-aos="fade-in" data-aos-delay="100">
                            <div className="ar-vr-banner-text">
                                <h3>React Native <br />App Development Company</h3>
                            </div>
                        ...
                        <div className="col-lg-4">
                            <div className="react-banner">
                                <img className="img-fluid" src="img/react-native-hero.png" alt="react native mobile app development" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <main id="main">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-sm-12">
                                <p className="text-center big-p">Techno Yuga is a top rated react native app development company that is helping startups, small businesses and growing enterprises around the world.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="what-is-react-native">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-8 mb-5 mb-lg-0">
                                <div className="about-react-native">
                            ...
                            <div className="col-lg-4" data-aos="fade-down" data-aos-delay="100">
                                <figure>
                                    <img className="img-fluid" src="img/about-react-native.png" />
                                </figure>
                                <figcaption className="text-center">Made by <span className="fb-color">Facebook</span></figcaption>
                            </div>
                        </div>
                    </div>
                </section>

                <section className="apps-built text-center">
                    <div className="container">
                            ...
                            {window.innerWidth < 420 ?
                                <ul>
                                    ...
                                    >
                                        ...
                                        <li>
                                            <img src="img/flipkart.svg" />
                                        </li>
                                        <li>
                                            <img src="img/uber-eats.svg" />
                                        </li>
                                        <li>
                ...
                <section className="why-use-react-native">
                    <div className="container">
                        <h4 className="text-center">Why should you use React Native for your Mobile App Development Project?</h4>
                        <div className="why-use-wrapper">
                            <div className="row">
                                <div className="col-lg-6" data-aos="fade-in" data-aos-delay="100">
                                    <div className="inner-wrapper">
                                        <img src="img/native-perfo.svg" />
                                        <h5>Native Performance</h5>
                                        <p>React Native offers the best UI Design framework which has a great JS Library that helps us to build great cross platform mobile apps on iOS and Android Platforms.</p>
                                    </div>
                                </div>
                                <div className="col-lg-6" data-aos="fade-in" data-aos-delay="200">
                                    <div className="inner-wrapper">
                                        <img src="img/cost-benifits.svg" />
                                        <h5>Cost Benifits</h5>
                                        <p>Being the startup cost plays a major role. Since React uses a single codebase (In most of the scenarios) which reduces our efforts by at least 30% and we transfer this benefit to our client by reducing the development cost.</p>
                                    </div>
                                </div>
                                <div className="col-lg-6" data-aos="fade-in" data-aos-delay="300">
                                    <div className="inner-wrapper">
                                        <img src="img/cross-platform-icon.svg" />
                                        <h5>Cross Platform Compatibility</h5>
                                        <p>React Native framework offers cross-platform compatibility. We can write one react native component and it will work smoothly for both iOS and Android Apps.</p>
                                    </div>
                                </div>
                                <div className="col-lg-6" data-aos="fade-in" data-aos-delay="400">
                                    <div className="inner-wrapper">
                                        <img src="img/community-support.svg" />
                                        <h5>Community Support</h5>
                                        <p>React Native had the 2nd highest number of contributors for any repository in GitHub back in 2018. React Native framework has great community support and the community is always bringing exciting projects and exploring the platform beyond Mobile Platforms (iOS & Android) with repos like React Native MacOS, React Native Web and React Native Windows.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="ios-process">
                    <div className="container">
                        <div className="section-title" data-aos="fade-up">
                            <h2>Your React Native App project in the safe hands.</h2>
                            ...
                            <div className="card mb-0">
                                <div className="faq-wrapper">
                                    <div className="card-header collapsed" data-toggle="collapse" href="#collapseOne">
                                        <a className="card-title">
                                            Does React Native Framework really reduce the development cost of Mobile app development?
                                        </a>
                                    </div>
                                    <div id="collapseOne" className="card-body collapse" data-parent="#accordion" >
                                        <p>React Native allows our developers to use a single code-base and provide them with a mechanism to build cross platform Mobile apps on iOS & Android Platform. Developers do not need to build mobile apps for iOS and Android separately with React Native. In this 80-90 percent of a codebase can be shared across platforms, depending on the application's complexity.</p>
                                        <p>This means as a company we are saving one resource's efforts, compared to native app development processes. This helps us to reduce our cost and provide the cost benefits to our clients.</p>
                                    </div>
                                </div>
                                <div className="faq-wrapper">
                                    <div className="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                        <a className="card-title">
                                            May I know the names of some successful startups that use React Native for their App Development?
                                        </a>
                                    </div>
                                    <div id="collapseTwo" className="card-body collapse" data-parent="#accordion" >
                                        <p>React Native has been popular in startups and many startups and Enterprises used React Framework for their product development. You can check few of them listed as mentioned below:</p>
                                        <ul>
                                            <li>Instagram</li>
                                            <li>Skype</li>
                                            <li>Flipkart</li>
                                ...
                                <div className="faq-wrapper">
                                    <div className="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                        <a className="card-title">
                                            What are the competitors for React Native currently and are they equally good as React Native?
                                        </a>
                                    </div>
                                    <div id="collapseThree" className="collapse" data-parent="#accordion" >
                                        <div className="card-body">
                                            <p>There are many cross-platform tools. You can check few of them as mentioned below:</p>
                                            <ul>
                                                <li>Flutter </li>
                                                <li>Ionic</li>
                                                <li>Xamarin</li>
                                ...
                                <div className="faq-wrapper">
                                    <div className="card-header collapsed" data-toggle="collapse" href="#collapseFour">
                                        <a className="card-title">
                                            When should one use the React Native platform for App Development?
                                        </a>
                                    </div>
                                    <div id="collapseFour" className="card-body collapse" data-parent="#accordion" >
                                        <p>If the App you wish to build is based on business logic , UI and less native features involvement, React Native will be the great option for app development. You can choose react native in following scenarios:</p>
                                        <ul>
                                            <li>MVP (Minimum Viable Product) that requires a basic client server architecture.</li>
                                            <li>Apps with standard interactions and UI</li>
                                            <li>Enterprise Apps</li>
                                        </ul>
                                        <p>In case your App involves extensive Native features like Camera etc. In this case the Native app development is the best viable solution. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
